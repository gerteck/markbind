...
<header sticky>
  <navbar type="dark">
    ...
    <dropdown header="Topics" class="nav-link">
      <li><a href="{{baseUrl}}/contents/topic1.html" class="dropdown-item">Topic 3a</a></li>
      <li><a href="{{baseUrl}}/contents/topic1.html" class="dropdown-item">Topic 3b</a></li>
    </dropdown>
    <li slot="right">
